...
2. Install [Tempad 3.x](https://www.curseforge.com/minecraft/mc-mods/tempad) on the client and server.
3. Install [Xaero's Minimap](https://www.curseforge.com/minecraft/mc-mods/xaeros-minimap) on the client.
4. Put `tempadtomapx-0.1.0+neoforge-1.21.1.jar` in the `mods` folder on each required side.

## Dependencies

- Required: [Tempad](https://www.curseforge.com/minecraft/mc-mods/tempad) 3.x on the client and server.
- Optional client display: [Xaero's Minimap](https://www.curseforge.com/minecraft/mc-mods/xaeros-minimap).
